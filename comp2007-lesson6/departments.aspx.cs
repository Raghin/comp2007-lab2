...
{
    public partial class derpartments : System.Web.UI.Page
    {
        ...
        {
            //connect using our connection string from web.config and the EF context class
            var conn = new DefaultConnection();

            //use link to query the Departments model
            var deps = from d in conn.Departments select d;
